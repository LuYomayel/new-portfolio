    ...
    <div className="min-h-screen bg-gray-100 text-gray-800 font-sans">
      ...
      >
        ...
        <Image
            ...
            />
          <h1 className="text-4xl md:text-6xl font-bold mb-2 animate-fade-in">Luciano Yomayel</h1>
          <p className="text-xl md:text-2xl animate-fade-in animation-delay-300">Full Stack Developer</p>
        </div>
      </div>
      ...
      >
        <div className="container mx-auto px-4 py-12 flex flex-col md:flex-row md:space-x-8">
          {/* Left Side - Sticky */}
          <div className="md:w-1/3 space-y-8 md:sticky md:top-20 md:self-start">
            {/* About Me */}
          ...
          <div className="md:w-2/3 space-y-8 mt-8 md:mt-0 md:overflow-y-auto md:max-h-[calc(100vh-5rem)]">
            {/* Work Experience */}
            <section className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-6">
                {workExperience.map((job, index) => (
                  <div key={index} className="border-l-4 border-navy-600 pl-4 transition-all hover:shadow-lg hover:border-l-8 p-4 rounded">
                    ...
                    {job.url && (
                      <Link href={job.url} className="mt-2 inline-block text-navy-600 hover:underline">
                        View Project
                      </Link>
                    )}
                  </div>
